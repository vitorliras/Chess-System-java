...
public class ChessMatch { // classe que serve para a s jogadas do xadrez
	...
	private Piece makeMove(Position source, Position target) {
		...
		if( p instanceof King && target.getColumn() == source.getColumn() + 2) { // condição para tratar o movimento do roque pequeno, roque do lado do rei
		...
		if( p instanceof King && target.getColumn() == source.getColumn() - 2) { // condição para tratar o movimento do roque grande, roque do lado da rainha
